      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                //colorFilter: new ColorFilter.mode(Color.fromARGB(255, 198, 104, 198), BlendMode.dstATop),
                image: const AssetImage('assets/img/aaa.png'),
                fit: BoxFit.cover)),
        child: Column(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                      ...
                      icon: Icon(
                        Icons.send,
                        color: Color.fromARGB(255, 152, 74, 166),
                      ))
                ],
              ),
            )
